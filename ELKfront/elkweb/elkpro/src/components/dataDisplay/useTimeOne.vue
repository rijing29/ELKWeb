                ...
                <el-col :span="12">
                    <el-row class="text">
                        ...
                        <el-col class="title" :span="16" style="text-align: left">
                            <el-button type="success" round icon="el-icon-top-right" @click="export2Excel" size="mini">
                                导出
                            </el-button>
                        </el-col>
                    </el-row>
                        ...
                        <el-col :span="24" style="padding: 0">
                            <div class="table-wrapper">
                                ...
                                <el-table :data="tableData" style="width: 100%"
                                          :header-cell-style="{color: '#17caf0',fontSize:'16px'}" height="500">
...
export default {
    ...
    methods: {
        ...
        getModuleCount() {
            console.log(this.softwareName,this.startTime,this.stopTime,"++++++++++++")
            //渲染数据
