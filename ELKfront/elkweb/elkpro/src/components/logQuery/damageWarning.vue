<template>
    <el-container>
        <el-main>
            ...
            <el-row>
                <!--————表格区域 begin————-->
                <el-col :span="24" v-if="haveData" class="area">
                    <el-row>
                        ...
                        <el-col :span="24" style="padding: 0">
                            <div class="table-wrapper">
                                <el-table :data="tableData" style="width: 100%;margin-bottom: 10px;" height="650">
                                    ...
                                    <el-table-column prop="MOUDLE_NAME" sortable label="模块名"
                                                     align="center"></el-table-column>
                                </el-table>
                                <!-- 外表格 end-->
                            </div>
...
export default {
    ...
    methods: {
        ...
        getCdnDataLog() {//getCdnDataLogMapper.xml - ELKLogQueryController.java
            var url = "/getCdnDataLog"
